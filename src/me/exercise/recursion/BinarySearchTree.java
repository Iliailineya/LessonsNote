...
public class BinarySearchTree {
    ...
    public BinarySearchTree() { // Пустое дерево
        rootNode = null;
    }

    public TreeNode findNodeByValue(int value) { // поиск узла по значению
        TreeNode currentNode = rootNode; // начинаем поиск с корневого узла
    ...
    public void insertNode(int value) { // метод вставки нового элемента
        ...
        if (rootNode == null) { // если корневой узел не существует
            ...
            TreeNode currentNode = rootNode; // начинаем с корневого узла
            TreeNode parentNode;
